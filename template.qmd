...
- [UBD40 Deep Red]{.ubddeepred}: `ubddeepred` ([#B71757]{.bg style="--col: #B71757"})
- [UBD40 Bright Red]{.ubdbrightred}: `ubdbrightred` a.k.a. Red Crayola ([#E81856]{.bg style="--col: #E81856"})
- [UBD40 Soft Red]{.ubdsoftred}: `ubdsoftred` a.k.a. Light Pink Crayola ([#F05A91]{.bg style="--col: #F05A91"})
...
# Features {.transition-slide-ubdsoftred}

This is a `{.transition-slide-ubdsoftred}` transition slide.
...
- I've also added some convenient CSS classes, e.g. `.ubdblue`, `.ubdteal`, `.ubdyellow`, `.ubdred`, `.ubddeepred`, `.ubdsoftred`, `.ubdgray`.
...
# Code {.transition-slide-ubddeepred}

This is a `{.transition-slide-ubddeepred}` transition slide.
